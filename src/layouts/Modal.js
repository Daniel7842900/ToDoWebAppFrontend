    ...
    >
      ...
      <div className="fixed inset-0 z-10 w-full overflow-y-auto">
        <div className="flex basis-full h-full w-10/12 mx-auto items-start justify-center text-center sm:items-center sm:p-0">
          <div className="relative h-screen lg:h-1/2 w-full flex flex-col transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
